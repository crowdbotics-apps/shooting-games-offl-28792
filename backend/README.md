...
## Project Structure
    ...
    ├── shooting_games_offl_28792  # Django project configurations
...
1. Clone this repo and `cd shooting_games_offl_28792`
...
2. Clone this repo and `cd shooting_games_offl_28792`
